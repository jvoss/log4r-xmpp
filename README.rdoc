...
===Options:
 ...
 :buffsize   => The number of logging events to buffer before sending
 :username   => Sending user's XMPP/Jabber account
 :password   => Sending user's XMPP/Jabber account password
 :resource   => Sending user's XMPP/Jabber resource (optional)
 :recipients => An array of accounts to send Log4r messages to
